...
<head>
    ...
    <title>Database Error | St.Lawrence-Cafeteria</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold text-wrap">Cannot connect to St.Lawrence-Cafeteria database right now.</p>
