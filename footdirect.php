...
<head>
    ...
    <title>About Us | St.Lawrence-Cafeteria</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
        ...
        <h4 class="mt-2 mb-3 fw-normal ">St. Lawrence College</h4>
        <p class="mt-2 mb-3 fw-normal h6 ">Department Of BCS CSIT</p>
        <h4 class="mt-2 mb-3 fw-normal ">Co-Ordinator</h4>
        <p class="mt-2 mb-3 fw-normal h6 ">Basanta Gyalwali</p>
